    ...
    <div class="row g-3 clearfix row-deck">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="row g-3" action="{{url('letterUpdate/'.$list->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-6 mb-4">
                                <label for="name">Name <span class="text-danger">*</span></label>
                                <input type="text" name="name" class="form-control" id="name" value="{{$list->name}}" required />
                                @if($errors->has('name'))
                            ...
                            <div class="col-12 mb-4">
                                ...
                                <input type="text" name="address" class="form-control" id="address" value="{{$list->address}}" required />
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control" name="content" id="content" style="height: 350px;" required>
                                    {{$list->content}}
                                </textarea>
                            ...
                            <div class="col-6">
                                <button type="submit" class="btn btn-primary btn-lg btn-block mt-4">Update Letter</button>
                            </div>
                        </div>
                    </form>
                </div>
